...
CREATE TABLE [dbo].[tmp_ms_xx_FATO_001] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_FATO_0011] PRIMARY KEY CLUSTERED ([Cod_Dia] ASC, [CD_FILIAL] ASC, [CD_CLIENTE] ASC, [CD_REPRES] ASC, [CD_REGIAO] ASC, [CD_ITEM] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[FATO_001])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_FATO_001] ([Cod_Dia], [CD_FILIAL], [CD_CLIENTE], [CD_REPRES], [CD_REGIAO], [CD_ITEM], [QT_VENDIDO], [QT_FATURADO], [VL_FATURADO], [VL_VENDIDO], [CD_GRUPO], [CD_SUBGRUPO], [CD_LINHA], [CD_LINHA_COTA], [CD_DIVISAO], [DT_SINC])
        SELECT   [Cod_Dia],
                 [CD_FILIAL],
                 [CD_CLIENTE],
                 [CD_REPRES],
                 ...
                 [DT_SINC]
        FROM     [dbo].[FATO_001]
        ORDER BY [Cod_Dia] ASC, [CD_FILIAL] ASC, [CD_CLIENTE] ASC, [CD_REPRES] ASC, [CD_REGIAO] ASC, [CD_ITEM] ASC;
    END
