...
GO
PRINT N'The following operation was generated from a refactoring log file ad12cf3b-e7ed-4b41-9117-3bdec408a1a3';

PRINT N'Rename [dbo].[FATO_001].[CD_DIVISAO_LINHA] to CD_DIVISAO_LINHAS';


GO
EXECUTE sp_rename @objname = N'[dbo].[FATO_001].[CD_DIVISAO_LINHA]', @newname = N'CD_DIVISAO_LINHAS', @objtype = N'COLUMN';
