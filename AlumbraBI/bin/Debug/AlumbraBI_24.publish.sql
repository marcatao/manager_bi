...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DIM_CLIENTE] ([CD_CLIENTE], [CD_CGCCPF], [DN_FANTASIA], [CD_MUNICIPIO], [DN_MUNICIPIO], [DN_BAIRRO], [CD_CEP], [NR_ENDERECO], [CD_UF], [DN_UF], [TP_SITUACAO_SGE], [VL_LIMITE_CRED], [DT_SINC])
        SELECT   [CD_CLIENTE],
                 [CD_CGCCPF],
                 [DN_FANTASIA],
                 [CD_MUNICIPIO],
