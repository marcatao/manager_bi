...
GO
PRINT N'Altering [dbo].[DIM_DIVISOES]...';


GO
ALTER TABLE [dbo].[DIM_DIVISOES] ALTER COLUMN [ICON] CHAR (15) NULL;


GO
PRINT N'Refreshing [dbo].[DIM_DIVISOES_MERGE]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[DIM_DIVISOES_MERGE]';
