...
GO
PRINT N'Creating [dbo].[CD_LINHA]...';


GO
ALTER TABLE [dbo].[DIM_PRODUTOS] WITH NOCHECK
    ADD CONSTRAINT [CD_LINHA] FOREIGN KEY ([CD_GRUPO], [CD_SUBGRUPO]) REFERENCES [dbo].[DIM_LINHAS_SGE] ([CD_GRUPO], [CD_SUBGRUPO]);
...
GO
ALTER TABLE [dbo].[DIM_PRODUTOS] WITH CHECK CHECK CONSTRAINT [CD_LINHA];
