...
GO
/*
The column [dbo].[FATO_003].[CD_GRUPO] is being dropped, data loss could occur.

The column [dbo].[FATO_003].[CD_SUBGRUPO] is being dropped, data loss could occur.
*/
...
CREATE TABLE [dbo].[tmp_ms_xx_FATO_003] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_FATO_0031] PRIMARY KEY CLUSTERED ([Cod_Mes_Ano] ASC, [CD_FILIAL] ASC, [CD_REPRES] ASC, [CD_REGIAO] ASC, [CD_LINHA_COTA] ASC, [CD_DIVISAO] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[FATO_003])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_FATO_003] ([Cod_Mes_Ano], [CD_FILIAL], [CD_REPRES], [CD_REGIAO], [CD_LINHA_COTA], [CD_DIVISAO], [VL_COTA], [CD_DIVISAO_LINHA], [DT_SINC])
        SELECT   [Cod_Mes_Ano],
                 [CD_FILIAL],
                 [CD_REPRES],
                 [CD_REGIAO],
                 ...
                 [DT_SINC]
        FROM     [dbo].[FATO_003]
        ORDER BY [Cod_Mes_Ano] ASC, [CD_FILIAL] ASC, [CD_REPRES] ASC, [CD_REGIAO] ASC, [CD_LINHA_COTA] ASC, [CD_DIVISAO] ASC;
    END
