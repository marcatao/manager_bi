...
GO
PRINT N'Creating [dbo].[FK_DIM_LINHAS_AGRUPADAS_DIM_DIVISAO]...';


GO
ALTER TABLE [dbo].[DIM_LINHAS_AGRUPADAS] WITH NOCHECK
    ADD CONSTRAINT [FK_DIM_LINHAS_AGRUPADAS_DIM_DIVISAO] FOREIGN KEY ([CD_DIVISAO]) REFERENCES [dbo].[DIM_DIVISOES] ([CD_DIVISAO]);
...
GO
ALTER TABLE [dbo].[DIM_LINHAS_AGRUPADAS] WITH CHECK CHECK CONSTRAINT [FK_DIM_LINHAS_AGRUPADAS_DIM_DIVISAO];
